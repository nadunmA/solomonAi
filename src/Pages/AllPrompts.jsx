      ...
      <div className="relative z-10 pt-16 pb-20 px-4 sm:pt-24 sm:px-6 lg:px-8 w-full box-border">
        <div className="max-w-7xl mx-auto w-full box-border">
          ...
          <div className="space-y-16 sm:space-y-20 w-full box-border">
            {displayData.map((item, index) => (
              ...
              >
                ...
                <div className="w-full lg:w-1/2 box-border">
                  ...
                  >
                    <div className="relative overflow-hidden rounded-2xl glass-panel max-w-full box-border z-10">
                      <img
                        loading="lazy"
                        src={item.image}
                        alt={item.alt}
                      ...
                      {/* Corner brackets — Fixed boundary points to avoid structural responsive glitches */}
                ...
                <div className="w-full lg:w-1/2 box-border">
                  <div className="space-y-5 w-full box-border">
                    ...
                    <div className="relative glass-panel rounded-2xl p-6 max-w-full box-border">
                      {/* scanline */}
                      ...
                      <div className="flex flex-col gap-3 w-full box-border">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-[var(--glass-border)] w-full">
                          <button
                            ...
                            className="font-mono text-xs text-[var(--text-muted)] hover:text-[var(--text-primary)] flex items-center gap-1 transition-colors cursor-pointer"
                          >
            ...
            {/* ── Dynamic HUD Navigation (Page 01 Specific Bounds Configuration) ── */}
